...
I am currently an AI Infrastructure Engineer at [Moore Threads AI](https://www.mthreads.com/), focusing on efficient distributed training for large language models. Previously, I completed my master's degree at the School of Computer Science, Zhejiang University, where I was affiliated with the [State Key Laboratory of CAD & CG](http://www.cad.zju.edu.cn/) and was fortunate to be supervised by Prof. [Qiang Zou](https://qiang-zou.github.io/). Prior to this, I completed my undergraduate studies at Dalian University of Technology, under the guidance of Prof. [Miao Zhang](https://scholar.google.com/citations?hl=zh-CN&user=Uu5ct6YAAAAJ&view_op=list_works&sortby=pubdate).

My research interests include but are not limited to geometric modeling, computer-aided design, parallel computing, computer graphics and large language models. Currently, I'm working on high-performance distributed training for llm on GPUs.
